...
<section class="content col-sm-12">
	<div class="box box-info"   >
		<div class="box-header with-border">
			<h3 class="box-title">Subscribers Report</h3>
		...
		<!-- /.box-header -->
		<div class="box-body">
			<form action="" method="post" id="creport">
				...
				<input class="btn btn-success" type="button" value="Get Report" id="submit-report" name="submit">
			</form>
            <br>
            <div id="reportPanel" class="">
			<table class="table table-bordered table-hover" border="1" style="width: 100%;" id="reportTable">
				<thead>
				<tr>
					<th>#</th>
        ...
        <div id="printHeader" style="display: none; ">
                <div id="page-wrapper">
                    <div id="page-inner">
                        ...
                        <br/><br/>
                        <div class="row">
                            <div  class="row text-center contact-info" style="padding:0px 50px 0px 0px; font-style: oblique;" >
                                <hr />
                                <span>
             &emsp;
		...
		<div class="box-footer clearfix">
			<button class="btn btn-sm btn-info btn-flat pull-left" id="printReport">Print</button>
